...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";return e=>({
...
"meta-keyword":"if else elseif end region externalsource"}}]})})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=(t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},i={className:"string",
...
skip:!0})]}]})})());hljs.registerLanguage("swift",(()=>{"use strict";return e=>{var i={
$pattern:/[\w#]+/,
...
},relevance:0}]})})());hljs.registerLanguage("sql",(()=>{"use strict";return e=>{
