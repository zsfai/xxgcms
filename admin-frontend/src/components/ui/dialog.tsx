    ...
    <DialogOverlay>
      ...
      >
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            'relative w-full border bg-card shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95',
            fullscreen
              ? 'my-0 flex h-[100dvh] max-w-none flex-col rounded-none border-0 bg-background p-6'
              : 'my-8 grid max-w-lg gap-4 p-6 sm:rounded-lg',
            className,
          )}
          {...props}
        >
